...
const CACHE_NAME = "LongGammon-v20220308";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/GammonApp/long/',
  ORIGIN + '/GammonApp/long/index.html',
  ORIGIN + '/GammonApp/long/manifest.json',
  ORIGIN + '/GammonApp/long/icon/favicon.ico',
  ORIGIN + '/GammonApp/long/icon/apple-touch-icon.png',
  ORIGIN + '/GammonApp/long/icon/android-chrome-96x96.png',
  ORIGIN + '/GammonApp/long/icon/android-chrome-192x192.png',
  ORIGIN + '/GammonApp/long/icon/android-chrome-512x512.png',
