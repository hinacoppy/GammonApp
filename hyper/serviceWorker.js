...
const CACHE_NAME = "HyperGammon-v20220308";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/GammonApp/hyper/',
  ORIGIN + '/GammonApp/hyper/index.html',
  ORIGIN + '/GammonApp/hyper/manifest.json',
  ORIGIN + '/GammonApp/hyper/icon/favicon.ico',
  ORIGIN + '/GammonApp/hyper/icon/apple-touch-icon.png',
  ORIGIN + '/GammonApp/hyper/icon/android-chrome-96x96.png',
  ORIGIN + '/GammonApp/hyper/icon/android-chrome-192x192.png',
  ORIGIN + '/GammonApp/hyper/icon/android-chrome-512x512.png',
